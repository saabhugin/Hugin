...
rcreader2::rcreader2(int handle_, int num_channels_){
	handle = handle_;
	num_channels = num_channels_;
}

int rcreader2::get_handle(){
	return handle;
}

void rcreader2::set_handle(int handle_){
	handle = handle_;
}

int rcreader2::get_num_channels(){
	return num_channels;
}

void rcreader2::set_num_channels(int num_channels_){
	num_channels = num_channels_;
}

int rcreader2::get_readings(int* channels){	
...
void rcreader2::parse_SBus(int* channels, double* SBus_channels_d){
...
void rcreader2::set_pwm(double* pwm, int ch){
	int pwm_us[ch];
	uint8_t buffer[ch*2];
